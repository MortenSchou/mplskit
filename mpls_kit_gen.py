...
----------
    ...
    random_seed_gen       Random seed. Leave empty to pick a random one.
...
if __name__ == "__main__":
    ...
    p.add_argument("--random_seed_gen",type=int, default = random.randint(0, 99999999), help="Random seed. Leave empty to pick a random one.")
